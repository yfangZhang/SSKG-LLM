...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("/root/zhangyf/models/Qwen1.5-14B-Chat")
    tokenizer.pad_token_id = (
        0  # unk. we want this to be different from the eos token
    )
    tokenizer.padding_side = "left" 
    retrievers = WordnetRetriever("/data/kgs")
    args_dict = dict()
    ...
    # print("words_ent_list",words_ent_list)
    # print("doc_conceptids2synse",doc_conceptids2synset)
    print("Wordnet_token",token)
